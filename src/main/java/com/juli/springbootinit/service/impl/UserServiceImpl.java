...
import static com.juli.springbootinit.constant.UserConstant.USER_LOGIN_STATE;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements UserService {
     ...
     * 盐值，混淆密码
     */
    private static final String SALT = "julii";
    ...
    public User getSafetyUser(User originUser){
        ...
        saftyUser.setUserAvatar(originUser.getUserAvatar());
